...
> 슬라이드별 발표자 내레이션. `presentation/slides/index.html`과 나란히 사용.
> 데모 단계 체크리스트는 `presentation/speaker/checklist.md` 참조.
...
> 아마 많은 분이 사내 보안망에 막혀 openai.com 원문 접속이 안 되셨을 겁니다. 제가 요약봇이 되어 핵심만 짚어드립니다 —
...
> AI가 아무리 그럴싸한 거짓말을 쳐도, 테스트 코드는 속지 않거든요.
